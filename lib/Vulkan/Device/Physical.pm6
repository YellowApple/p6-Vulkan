...
our class Limits is repr('CStruct') {
    ...
    has uint32 $.max-compute-work-group-count-x;
    has uint32 $.max-compute-work-group-count-y;
    has uint32 $.max-compute-work-group-count-z;
    has uint32 $.max-compute-work-group-invocations;
    has uint32 $.max-compute-work-group-width;
    has uint32 $.max-compute-work-group-height;
    has uint32 $.max-compute-work-group-depth;
    ...
    has uint32 $.max-viewport-width;
    has uint32 $.max-viewport-height;
    has num32 $.min-viewport-bound;
    has num32 $.max-viewport-bound;
    ...
    has num32 $.min-point-size;
    has num32 $.max-point-size;
    has num32 $.min-line-width;
    has num32 $.max-line-width;
